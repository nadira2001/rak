...
#         ================SL ready============
     ...
     # Nazma Azam 2019-02-01 end
        ...
        #             ===============2019-02-01 novivo2019 start ================
            farmInsert = db.sm_farm.insert(cid=cid, farm_id=farm_id, farm_name=addPName,farm_type='POULTRY' ,latitude=latitude, longitude=longitude, owner_name=addPOName ,route=farm_area_id_val, address=AddressP, mobile_no=MobileP, medicine=chemist_medicine_p, manger_name=managerP,consultant_name=consultantP, category=addCCategoryP, birds_animal=birds_animal_p, rearing_housing=rearingP, feeding=feedingP, watering=wateringP ,brooding=broodingP , poandsSize=addPondsP, anniversary=anniversaryP, dob=addCDOBp)
