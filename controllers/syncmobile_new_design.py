...
# ==================================
            ...
            doctorStr_flag=0
            if (user_type == 'rep'):
                linkpathRows = db((db.sm_linkpath.cid == cid) & (db.sm_linkpath.user_type == 'rep')).select(db.sm_linkpath.link_name, db.sm_linkpath.link_path, db.sm_linkpath.field1, orderby=db.sm_linkpath.field2)
#                 return db._lastsql
                linkStr=''
...
#                 return menuStr
                ...
                linkpathRows = db((db.sm_linkpath.cid == cid) & (db.sm_linkpath.user_type == 'sup')).select(db.sm_linkpath.link_name, db.sm_linkpath.link_path, db.sm_linkpath.field1,orderby=db.sm_linkpath.field2)
#                 return db._lastsql
                linkStr=''
                for linkpathRows in linkpathRows:
                    link_name = linkpathRows.link_name
...
#             return clientRow
            ...
            if clientRowTemp:
                ...
                dob='20210101'
                clientInsert=db.sm_client_temp.insert(cid =cid,client_id=visit_client ,name=visit_clientName,area_id=market_id,status='Rreq',note=inactive_reason,newChemist=0,dob=dob)
