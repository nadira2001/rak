...
# ========================DocCategory & Speciality
            ...
            spc_rows = "SELECT specialty FROM doc_speciality WHERE cid='"+cid+"' ORDER BY id "
...
def doctor_visit_submit_pharma():
    ...
    docVisitTime=str(request.vars.docVisitTime).strip()
...
def dmpath():
   ...
   # ====apu
    return '<start>http://w05.yeapps.com/navana/syncmobile_new_design_raw_sql_d_start/<fd>http://i001.yeapps.com/image_hub/static/mundi_image/<fd>http://i001.yeapps.com/image_hub/mundi_image/<fd>http://w05.yeapps.com/navana/syncmobile_new_design_raw_sql_d_start/<fd>http://w05.yeapps.com/navana/syncmobile_new_design_raw_sql_d_start/<fd>http://127.0.0.1:8000/navana/tour_web/<fd>http://w05.yeapps.com/navana/tour_web_members/<end>'
    # =====apu end
