...
#    my_date=get_mydate(gmt_time=session.gmt)
    ...
    sell_count=''
    rec_selldailyDatac=db((db.sm_order_head.cid == c_id) & (db.sm_order_head.order_date ==current_date)).select(db.sm_order_head.id.count(), orderby=db.sm_order_head.id)
    ...
    doc_count=''
    rec_DocdailyDatac=db((db.sm_doctor_visit.cid == c_id) & (db.sm_doctor_visit.visit_date ==current_date)).select(db.sm_doctor_visit.doc_id.count(), orderby=db.sm_doctor_visit.doc_id)
    ...
    checkIn_count=''
    rec_checkIndailyDatac=db((db.sm_tracking_table.cid == c_id) & (db.sm_tracking_table.visit_date ==current_date) & (db.sm_tracking_table.call_type =='CHECKIN')).select(db.sm_tracking_table.id.count(), orderby=db.sm_tracking_table.id)
    ...
    farm_count=''
    rec_farmdailyDatac=db((db.sm_farm_visit.cid == c_id) & ((db.sm_farm_visit.created_on>=current_date) or (db.sm_farm_visit.created_on<current_date))).select(db.sm_farm_visit.id.count(), orderby=db.sm_farm_visit.id)
...
def daily_dataDcr():
    ...
    qset=qset(db.sm_doctor_visit.visit_date ==current_date) 
    
    rec_DocDailyData=qset.select(db.sm_doctor_visit.ALL, orderby=db.sm_doctor_visit.visit_date)
...
def daily_dataCheckIn():
    ...
    rec_checkIndailyDatac=qset.select(db.sm_tracking_table.ALL, orderby=db.sm_tracking_table.id)
...
def daily_dataFarm():
    ...
    # qset=qset (db.sm_tracking_table.visit_date ==current_date)
    # qset=qset (db.sm_tracking_table.call_type =='CHECKIN')
    rec_farmdailyData=db((db.sm_farm_visit.cid == c_id) & ((db.sm_farm_visit.created_on>=current_date) or (db.sm_farm_visit.created_on<current_date))).select(db.sm_farm_visit.ALL, orderby=db.sm_farm_visit.created_on)
...
def monthly_dataFarm():
    c_id=session.cid
    rec_farmmonthlyData=db((db.sm_farm_visit.cid == c_id) & ((db.sm_farm_visit.created_on>=current_date) or (db.sm_farm_visit.created_on<current_date))).select(db.sm_farm_visit.ALL, orderby=db.sm_farm_visit.created_on)
