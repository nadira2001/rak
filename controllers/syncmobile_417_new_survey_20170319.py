...
def dmpath():
    ...
    return '<start>http://127.0.0.1:8000/survey/syncmobile_417_new/<fd>http://e2.businesssolutionapps.com/mrepbiopharma/static/<fd>http://104.155.225.205/gpl_image/syncmobile_prescription/<fd>http://127.0.0.1:8000/survey/syncmobile_417_new/<end>'
