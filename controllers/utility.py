...
#            return db._lastsql
            if not repRow:
                ...
                returnStr = 'User ID: ' + str(fieldForceId) + ', Password: ' + str(randNumber)  + '  Download Link:  http://im-gp.com/d/navana/ '
...
def process_report_show():
    ...
    if (session.search_type_pReport=='RSM'):
        if session.search_value_pReport=='' or session.search_value_pReport==None:
            records=db(db.sm_temp_report.cid==c_id).select(db.sm_temp_report.region_id,db.sm_temp_report.region_name,db.sm_temp_report.m1_amt.sum(),db.sm_temp_report.m2_amt.sum(),db.sm_temp_report.m1_order_count.sum(),db.sm_temp_report.m2_order_count.sum(),orderby=db.sm_temp_report.region_id,groupby=db.sm_temp_report.region_id|db.sm_temp_report.region_name,limitby=limitby)
        else:
            region_id=str(session.search_value_pReport).split('|')[0]
            records=db((db.sm_temp_report.cid==c_id)&(db.sm_temp_report.region_id==region_id)).select(db.sm_temp_report.region_id,db.sm_temp_report.region_name,db.sm_temp_report.m1_amt.sum(),db.sm_temp_report.m2_amt.sum(),db.sm_temp_report.m1_order_count.sum(),db.sm_temp_report.m2_order_count.sum(),orderby=db.sm_temp_report.region_id,groupby=db.sm_temp_report.region_id|db.sm_temp_report.region_name,limitby=limitby)
    
    elif (session.search_type_pReport=='TL'):
        if session.search_value_pReport=='' or session.search_value_pReport==None:
            records=db(db.sm_temp_report.cid==c_id).select(db.sm_temp_report.region_id,db.sm_temp_report.region_name,db.sm_temp_report.tl_id,db.sm_temp_report.tl_name,db.sm_temp_report.m1_amt.sum(),db.sm_temp_report.m2_amt.sum(),db.sm_temp_report.m1_order_count.sum(),db.sm_temp_report.m2_order_count.sum(),orderby=db.sm_temp_report.region_id|db.sm_temp_report.tl_id,groupby=db.sm_temp_report.region_id|db.sm_temp_report.region_name|db.sm_temp_report.tl_id|db.sm_temp_report.tl_name, limitby=limitby)
        else:
            tl_id=str(session.search_value_pReport).split('|')[0]
            records=db((db.sm_temp_report.cid==c_id)&(db.sm_temp_report.tl_id==tl_id)).select(db.sm_temp_report.region_id,db.sm_temp_report.region_name,db.sm_temp_report.tl_id,db.sm_temp_report.tl_name,db.sm_temp_report.m1_amt.sum(),db.sm_temp_report.m2_amt.sum(),db.sm_temp_report.m1_order_count.sum(),db.sm_temp_report.m2_order_count.sum(),orderby=db.sm_temp_report.region_id|db.sm_temp_report.tl_id,groupby=db.sm_temp_report.region_id|db.sm_temp_report.region_name|db.sm_temp_report.tl_id|db.sm_temp_report.tl_name,limitby=limitby)
    
    elif (session.search_type_pReport=='MPO'):
        if session.search_value_pReport=='' or session.search_value_pReport==None:
            records=db(db.sm_temp_report.cid==c_id).select(db.sm_temp_report.region_id,db.sm_temp_report.region_name,db.sm_temp_report.tl_id,db.sm_temp_report.tl_name,db.sm_temp_report.mpo_id,db.sm_temp_report.mpo_name,db.sm_temp_report.m1_amt.sum(),db.sm_temp_report.m2_amt.sum(),db.sm_temp_report.m1_order_count.sum(),db.sm_temp_report.m2_order_count.sum(),orderby=db.sm_temp_report.region_id|db.sm_temp_report.tl_id|db.sm_temp_report.mpo_id,groupby=db.sm_temp_report.region_id|db.sm_temp_report.region_name|db.sm_temp_report.tl_id|db.sm_temp_report.tl_name|db.sm_temp_report.mpo_id|db.sm_temp_report.mpo_name,limitby=limitby)
        else:
            mpo_id=str(session.search_value_pReport).split('|')[0]
            records=db((db.sm_temp_report.cid==c_id)&(db.sm_temp_report.mpo_id==mpo_id)).select(db.sm_temp_report.region_id,db.sm_temp_report.region_name,db.sm_temp_report.tl_id,db.sm_temp_report.tl_name,db.sm_temp_report.mpo_id,db.sm_temp_report.mpo_name,db.sm_temp_report.m1_amt.sum(),db.sm_temp_report.m2_amt.sum(),db.sm_temp_report.m1_order_count.sum(),db.sm_temp_report.m2_order_count.sum(),orderby=db.sm_temp_report.region_id|db.sm_temp_report.tl_id|db.sm_temp_report.mpo_id,groupby=db.sm_temp_report.region_id|db.sm_temp_report.region_name|db.sm_temp_report.tl_id|db.sm_temp_report.tl_name|db.sm_temp_report.mpo_id|db.sm_temp_report.mpo_name,limitby=limitby)
                        
    else:
        records=db(db.sm_temp_report.cid==c_id).select(db.sm_temp_report.region_id,db.sm_temp_report.region_name,db.sm_temp_report.tl_id,db.sm_temp_report.tl_name,db.sm_temp_report.mpo_id,db.sm_temp_report.mpo_name,db.sm_temp_report.m1_amt.sum(),db.sm_temp_report.m2_amt.sum(),db.sm_temp_report.m1_order_count.sum(),db.sm_temp_report.m2_order_count.sum(),orderby=db.sm_temp_report.region_id|db.sm_temp_report.tl_id|db.sm_temp_report.mpo_id,groupby=db.sm_temp_report.region_id|db.sm_temp_report.region_id|db.sm_temp_report.region_name|db.sm_temp_report.tl_id|db.sm_temp_report.tl_name|db.sm_temp_report.mpo_id|db.sm_temp_report.mpo_name,limitby=limitby)
...
#         records=db(db.sm_temp_report.cid==c_id).select(db.sm_temp_report.region_id,db.sm_temp_report.region_name,db.sm_temp_report.tl_id,db.sm_temp_report.tl_name,db.sm_temp_report.mpo_id,db.sm_temp_report.mpo_name,db.sm_temp_report.m1_amt.sum(),db.sm_temp_report.m2_amt.sum(),db.sm_temp_report.m1_order_count.sum(),db.sm_temp_report.m2_order_count.sum(),orderby=db.sm_temp_report.region_id|db.sm_temp_report.tl_id|db.sm_temp_report.mpo_id,groupby=db.sm_temp_report.region_id|db.sm_temp_report.tl_id|db.sm_temp_report.mpo_id)
    ...
    if (session.search_type_pReport=='RSM'):
        if session.search_value_pReport=='' or session.search_value_pReport==None:
            records=db(db.sm_temp_report.cid==c_id).select(db.sm_temp_report.region_id,db.sm_temp_report.region_name,db.sm_temp_report.m1_amt.sum(),db.sm_temp_report.m2_amt.sum(),db.sm_temp_report.m1_order_count.sum(),db.sm_temp_report.m2_order_count.sum(),orderby=db.sm_temp_report.region_id,groupby=db.sm_temp_report.region_id|db.sm_temp_report.region_name)
        else:
            region_id=str(session.search_value_pReport).split('|')[0]
            records=db((db.sm_temp_report.cid==c_id)&(db.sm_temp_report.region_id==region_id)).select(db.sm_temp_report.region_id,db.sm_temp_report.region_name,db.sm_temp_report.m1_amt.sum(),db.sm_temp_report.m2_amt.sum(),db.sm_temp_report.m1_order_count.sum(),db.sm_temp_report.m2_order_count.sum(),orderby=db.sm_temp_report.region_id,groupby=db.sm_temp_report.region_id|db.sm_temp_report.region_name)
    
    elif (session.search_type_pReport=='TL'):
        if session.search_value_pReport=='' or session.search_value_pReport==None:
            records=db(db.sm_temp_report.cid==c_id).select(db.sm_temp_report.region_id,db.sm_temp_report.region_name,db.sm_temp_report.tl_id,db.sm_temp_report.tl_name,db.sm_temp_report.m1_amt.sum(),db.sm_temp_report.m2_amt.sum(),db.sm_temp_report.m1_order_count.sum(),db.sm_temp_report.m2_order_count.sum(),orderby=db.sm_temp_report.region_id|db.sm_temp_report.tl_id,groupby=db.sm_temp_report.region_id|db.sm_temp_report.region_name|db.sm_temp_report.tl_id|db.sm_temp_report.tl_name)
        else:
            tl_id=str(session.search_value_pReport).split('|')[0]
            records=db((db.sm_temp_report.cid==c_id)&(db.sm_temp_report.tl_id==tl_id)).select(db.sm_temp_report.region_id,db.sm_temp_report.region_name,db.sm_temp_report.tl_id,db.sm_temp_report.tl_name,db.sm_temp_report.m1_amt.sum(),db.sm_temp_report.m2_amt.sum(),db.sm_temp_report.m1_order_count.sum(),db.sm_temp_report.m2_order_count.sum(),orderby=db.sm_temp_report.region_id|db.sm_temp_report.tl_id,groupby=db.sm_temp_report.region_id|db.sm_temp_report.region_name|db.sm_temp_report.tl_id|db.sm_temp_report.tl_name)
    
    elif (session.search_type_pReport=='MPO'):
        if session.search_value_pReport=='' or session.search_value_pReport==None:
            records=db(db.sm_temp_report.cid==c_id).select(db.sm_temp_report.region_id,db.sm_temp_report.region_name,db.sm_temp_report.tl_id,db.sm_temp_report.tl_name,db.sm_temp_report.mpo_id,db.sm_temp_report.mpo_name,db.sm_temp_report.m1_amt.sum(),db.sm_temp_report.m2_amt.sum(),db.sm_temp_report.m1_order_count.sum(),db.sm_temp_report.m2_order_count.sum(),orderby=db.sm_temp_report.region_id|db.sm_temp_report.tl_id|db.sm_temp_report.mpo_id,groupby=db.sm_temp_report.region_id|db.sm_temp_report.region_name|db.sm_temp_report.tl_id|db.sm_temp_report.tl_name|db.sm_temp_report.mpo_id|db.sm_temp_report.mpo_name)
        else:
            mpo_id=str(session.search_value_pReport).split('|')[0]
            records=db((db.sm_temp_report.cid==c_id)&(db.sm_temp_report.mpo_id==mpo_id)).select(db.sm_temp_report.region_id,db.sm_temp_report.region_name,db.sm_temp_report.tl_id,db.sm_temp_report.tl_name,db.sm_temp_report.mpo_id,db.sm_temp_report.mpo_name,db.sm_temp_report.m1_amt.sum(),db.sm_temp_report.m2_amt.sum(),db.sm_temp_report.m1_order_count.sum(),db.sm_temp_report.m2_order_count.sum(),orderby=db.sm_temp_report.region_id|db.sm_temp_report.tl_id|db.sm_temp_report.mpo_id,groupby=db.sm_temp_report.region_id|db.sm_temp_report.region_name|db.sm_temp_report.tl_id|db.sm_temp_report.tl_name|db.sm_temp_report.mpo_id|db.sm_temp_report.mpo_name)
                        
    else:
        records=db(db.sm_temp_report.cid==c_id).select(db.sm_temp_report.region_id,db.sm_temp_report.region_name,db.sm_temp_report.tl_id,db.sm_temp_report.tl_name,db.sm_temp_report.mpo_id,db.sm_temp_report.mpo_name,db.sm_temp_report.m1_amt.sum(),db.sm_temp_report.m2_amt.sum(),db.sm_temp_report.m1_order_count.sum(),db.sm_temp_report.m2_order_count.sum(),orderby=db.sm_temp_report.region_id|db.sm_temp_report.tl_id|db.sm_temp_report.mpo_id,groupby=db.sm_temp_report.region_id|db.sm_temp_report.region_id|db.sm_temp_report.region_name|db.sm_temp_report.tl_id|db.sm_temp_report.tl_name|db.sm_temp_report.mpo_id|db.sm_temp_report.mpo_name)
...
#clean depot test data, required login, url hit with depotID and password
#http://127.0.0.1:8000/skf/utility/clean_depot_data?depotid=340&password=sdf23423dfdg343fdgfd

#http://c003.cloudapp.net/skf/utility/clean_depot_data?cid=SKF&depotid=170&password=sdf23423dfdg343fdgfd
#http://c003.cloudapp.net/skf/utility/clean_depot_data?cid=SKF&depotid=120&password=sdf23423dfdg343fdgfd

def clean_depot_data():
    c_id=str(request.vars.cid)
    depotid=str(request.vars.depotid)
    password=str(request.vars.password)
    if c_id==None or depotid==None or password!='sdf23423dfdg343fdgfd':
        return 'Invalid Request:'+depotid+','+password
    else:
        depotid=str(depotid)
        ...
        #--------------        
        #client=db((db.sm_client.cid==c_id)&(db.sm_client.depot_id==depotid)).delete()
        ...
        return 'Data clean: Requisition,Issue,Receive,Damage,Dispute,Invoice,Return,Payment,Ledger; Data update: Order and stock '
