...
#     return 'FAILED<SYNCDATA>Please Try Later.'
    ...
    # Nazma Azam 2020-03-11 start
    version = str(request.vars.version).strip()
    # return version
    # Nazma Azam 2020-03-11 end
...
#                             return 'FAILED<SYNCDATA>You have already synced. Please retry after 30 minutes.'
            ...
            # Nazma Azam 2020-03-11 start version insert
            rep_update = repRow[0].update_record(sync_code=sync_code, first_sync_date=first_sync_date, last_sync_date=last_sync_date, sync_count=sync_count, field2=version)
            # Nazma Azam 2020-03-11 end
...
# ============================================            
            ...
            for productcomRow in productcomRow:
                item_id = productcomRow.item_id
                name = productcomRow.name
...
#     return location_detail
    ...
    payment_mode = str(request.vars.payment_mode).strip().upper()
    # Nazma Azam 2020-03-05 start delivery date
    del_dt=str(request.vars.delivery_date).strip()
    # return del_dt

    try:
        del_dt_mon=str(del_dt).split('/')[0]
        if len(str(del_dt_mon))<2:
            del_dt_mon='0'+del_dt_mon

        del_dt_day=str(del_dt).split('/')[1]
        if len(str(del_dt_day))<2:
            del_dt_day='0'+del_dt_day

        # return del_dt_day
        delivery_date = str(del_dt).split('/')[2]+'-'+ del_dt_mon+'-'+ del_dt_day

    except:
        delivery_date = str(del_dt)
    # Nazma Azam 2020-03-05 end delivery date
...
#             qset=qset(db.sm_invoice_head.status=='Invoiced')
            ...
            qset=qset(db.sm_invoice_head.client_id==client)
               ...
               # Nazma Azam 2020-03-05 start
            records=qset.select(db.sm_invoice_head.ALL,groupby=db.sm_invoice_head.store_id | db.sm_invoice_head.depot_id | db.sm_invoice_head.sl,orderby=~db.sm_invoice_head.sl | db.sm_invoice_head.depot_id | db.sm_invoice_head.store_id, limitby=(0,5))
            # return records
            # return db._lastsql
            # Nazma Azam 2020-03-05 end
            ...
            if records:  
                ...
                for record in records:  
                    ...
                    #
                    # invoice_str=invoice_str+'<table width="500" border="0" cellspacing="0" cellpadding="0" style="color:#306161">'
                    ...
                    # invoice_str=invoice_str+'<table width="500" border="0" cellspacing="0" cellpadding="0" style="color:#306161">'
                    # invoice_str=invoice_str+'<tr ><td width="100" style="padding-left:0px;"><b>Branch</b></td><td width="5"><b>:</b></td><td width="300" align="left">'+str(depot_name) + '('+str(depot_id) +')'+'</td><td width="100" style="padding-left:0px;"><b>D.Man</b></td><td width="5"><b>:</b></td><td width="300" align="left">'+str(d_man_name) + '('+str(d_man_id) +')'+'</td></tr>'
                    # invoice_str=invoice_str+'<tr ><td width="100" style="padding-left:0px;"><b>Store</b></td><td width="5"><b>:</b></td><td width="300" align="left">'+str(store_name) + '('+str(store_id) +')'+'</td><td width="100" style="padding-left:0px;"><b>DeliveryDate</b></td><td width="5"><b>:</b></td><td width="300" align="left">'+str(delivery_dt) +'</td></tr>'
                    # invoice_str=invoice_str+'<tr ><td width="100" style="padding-left:0px;"><b>Customer</b></td><td width="5"><b>:</b></td><td width="300" align="left">'+str(client_name) + '('+str(client) +')'+'</td><td width="100" style="padding-left:0px;"><b>Payment Mode</b></td><td width="5"><b>:</b></td><td width="300" align="left">'+str(payment_mode) +'</td></tr>'
                    # invoice_str=invoice_str+'<tr ><td width="100" style="padding-left:0px;"><b>Invoice SL</b></td><td width="5"><b>:</b></td><td width="300" align="left">'+str(sl) +'</td><td width="100" style="padding-left:0px;"><b>Discount</b></td><td width="5"><b>:</b></td><td width="300" align="left">'+str(discount) +'</td></tr>'
                    # invoice_str=invoice_str+'<tr ><td width="100" style="padding-left:0px;"><b>Order SL</b></td><td width="5"><b>:</b></td><td width="300" align="left">'+str(order_sl) +'</td><td width="100" style="padding-left:0px;"><b>Status Mode</b></td><td width="5"><b>:</b></td><td width="300" align="left">'+str(status) +'</td></tr>'
                    # invoice_str=invoice_str+'<tr ><td width="100" style="padding-left:0px;"><b>Notes</b></td><td width="5"><b>:</b></td><td width="300" align="left">'+str(note) +'</td></tr>'
                    # invoice_str=invoice_str+'</table>'

                    # invoice_str = invoice_str + '<table width="800" border="0" cellspacing="0" cellpadding="0" style="color:#306161">'
                    # invoice_str = invoice_str + '<tr ><td width="100" style="padding-left:0px;"><b>Branch</b></td><td width="5"><b>:</b></td><td width="300" align="left">' + str(depot_name) + '(' + str(depot_id) + ')' + '</td><td width="100" style="padding-left:0px;"><b>Order SL</b></td><td width="5"><b>:</b></td><td width="300" align="left">' + str(order_sl) + '</td><td width="100" style="padding-left:0px;"><b>Discount</b></td><td width="5"><b>:</b></td><td width="300" align="left">' + str(discount) + '</td></tr>'
                    # invoice_str = invoice_str + '<tr ><td width="100" style="padding-left:0px;"><b>Store</b></td><td width="5"><b>:</b></td><td width="300" align="left">' + str(store_name) + '(' + str(store_id) + ')' + '</td><td width="100" style="padding-left:0px;"><b>D.Man</b></td><td width="5"><b>:</b></td><td width="300" align="left">' + str(d_man_name) + '(' + str(d_man_id) + ')' + '</td><td width="150" style="padding-left:0px;"><b>Status Mode</b></td><td width="5"><b>:</b></td><td width="300" align="left">' + str(status) + '</td></tr>'
                    # invoice_str = invoice_str + '<tr ><td width="100" style="padding-left:0px;"><b>DeliveryDate</b></td><td width="5"><b>:</b></td><td width="300" align="left">' + str(delivery_dt) + '</td><td width="100" style="padding-left:0px;"><b>Notes</b></td><td width="5"><b>:</b></td><td width="300" align="left">' + str(note) + '</td></tr>'
                    #
                    # invoice_str = invoice_str + '<tr ><td width="100" style="padding-left:0px;"><b>Invoice SL</b></td><td width="5"><b>:</b></td><td width="300" align="left">' + str(sl) + '</td><td width="150" style="padding-left:0px;"><b>Payment Mode</b></td><td width="5"><b>:</b></td><td width="300" align="left">' + str(payment_mode) + '</td></tr>'
                    #
                    # invoice_str = invoice_str + '</table>'

                    invoice_str = invoice_str + '<table width="800" border="0" cellspacing="0" cellpadding="0" style="color:#306161">'
                    invoice_str = invoice_str + '<tr ><td width="100" style="padding-left:0px;"><b>Branch</b></td><td width="5"><b>:</b></td><td width="300" align="left">' + str(depot_name) + '(' + str(depot_id) + ')' + '</td><td width="100" style="padding-left:0px;"><b>Discount</b></td><td width="5"><b>:</b></td><td width="300" align="left">' + str(discount) + '</td><td width="150" style="padding-left:0px;"><b>Payment Mode</b></td><td width="5"><b>:</b></td><td width="300" align="left">' + str(payment_mode) + '</td></tr>'
                    invoice_str = invoice_str + '<tr ><td width="100" style="padding-left:0px;"><b>Store</b></td><td width="5"><b>:</b></td><td width="300" align="left">' + str(store_name) + '(' + str(store_id) + ')' + '</td><td width="100" style="padding-left:0px;"><b>D.Man</b></td><td width="5"><b>:</b></td><td width="300" align="left">' + str(d_man_name) + '(' + str(d_man_id) + ')' + '</td><td width="150" style="padding-left:0px;"><b>Status Mode</b></td><td width="5"><b>:</b></td><td width="300" align="left">' + str(status) + '</td></tr>'
                    invoice_str = invoice_str + '<tr ><td width="100" style="padding-left:0px;"><b>Invoice SL</b></td><td width="5"><b>:</b></td><td width="300" align="left">' + str(sl) + '</td><td width="100" style="padding-left:0px;"><b>DeliveryDate</b></td><td width="5"><b>:</b></td><td width="300" align="left">' + str(delivery_dt) + '</td><td width="100" style="padding-left:0px;"><b>Notes</b></td><td width="5"><b>:</b></td><td width="300" align="left">' + str(note) + '</td></tr>'
                ...
                # Nazma Azam 2020-03-05 end
                    ...
                    records_detail=qset_detail.select(db.sm_invoice.ALL,orderby=db.sm_invoice.item_name)#,orderby=~db.sm_invoice.item_name)
    #                 return records_detail
                    if records_detail:
                        item_id =''
                        item_name =''
                        ...
                        invoice_str=invoice_str+'<td ></td></tr>'
                        invoice_str=invoice_str+'</tr></table></br></br>'
                        # Nazma Azam 2020-03-05 start
    ...
    if not compRow:
        ...
        if not repRow:
           return 'FAILED<SYNCDATA>Invalid Authorization'+'<br><br><br>'
            ...
            # Nazma Azam 2020-03-05 start
            qset=qset(db.sm_order.rep_id==rep_id)
            # Nazma Azam 2020-03-05 end

            qset = qset(db.sm_order.client_id == client)

            records=qset.select(db.sm_order.ALL,groupby=db.sm_order.store_id | db.sm_order.depot_id | db.sm_order.sl ,orderby=~db.sm_order.sl| db.sm_order.depot_id  | db.sm_order.store_id ,limitby=(0,5))
            # return records
            # return db._lastsql
            if records:  
                depot_id=''
                ...
                for record in records:  
                    ...
                    invoice_str=invoice_str+'<table width="100%" border="0" cellspacing="0" cellpadding="0" style="color:#306161">'
                    invoice_str=invoice_str+'<tr ><td  style="padding-left:0px;"><b>Branch</b></td><td ><b>:</b></td><td  align="left">'+str(depot_name) + '('+str(depot_id) +')'+'</td></tr><tr><td style="padding-left:0px;"><b>OrderSL</b></td><td ><b>:</b></td><td align="left">'+str(sl) +'</td></tr>'
                    invoice_str=invoice_str+'<tr ><td  style="padding-left:0px;"><b>Store</b></td><td ><b>:</b></td><td  align="left">'+str(store_name) + '('+str(store_id) +')'+'</td></tr><tr><td style="padding-left:0px;"><b>OrderDate</b></td><td ><b>:</b></td><td align="left">'+str(order_datetime)+'</td></tr>'
                    invoice_str=invoice_str+'</table>'
                    ...
                    price=''
                    gross_total=0
                    invoice_str=invoice_str+"""<table  width="100%"  style="border-width: 1px;border-style: solid ;border-color: #F7F7F7;color:#306161;"> 
                        <tr  align="left" style="background-color:#A2D9CE; font-size:12px; font-weight:bold;" >
                        <td align="left"   >ID</td>
                        <td >Name</td>
                    ...
                    # Nazma Azam 2020-03-05 start
                    qset_detail = qset_detail(db.sm_order.depot_id == depot_id)
                    # qset_detail = qset_detail(db.sm_order.store_id == store_id)  #depot & sl mile unique
                    # qset_detail = qset_detail(db.sm_order.rep_id == rep_id)   #depot & sl mile unique
                    ...
                    for records_detail in records_detail:  
                        ...
                        invoice_str=invoice_str+'<tr  align="center" style="vertical-align:middle; font-size:11px; background-color:#D0ECE7;"><td  align="left" >'+str(item_id)+'</td>'
                        invoice_str=invoice_str+'<td align="left"  style="padding-left:0px;">'+str(item_name)+'</td>'
                    ...
                    invoice_str=invoice_str+'<tr  align="center"  style="vertical-align:middle; font-size:11px; background-color:#D0ECE7;"><td ></td>'
           ...
           return 'FAILED<SYNCDATA>Invalid Authorization'+'<br><br><br>'
            ...
            if noticeRow:
                ...
                for noticeRow in noticeRow:  
                    ...
                    notice_str = notice_str + '<b><p style="text-decoration:underline; font-size:16px; color: #26917C ; ">' + str(notice_date) + '</p></b>'
                    notice_str = notice_str + '<p >' + str(notice) + '</p><br>'
                    # Nazma Azam 2020-03-05 end
...
#             return docRow
            ...
            if docRow:  
                ...
                OtherChamber=docRow[0][db.sm_doctor.note]
                dPharmaRoute=docRow[0][db.sm_doctor.pharma_route]
                dNMDRoute=docRow[0][db.sm_doctor.nmd_route]
                rtn_str=str(dName)+'<fdfd>'+str(dSpaciality)+'<fdfd>'+str(dDegree)+'<fdfd>'+str(dCaegory)+'<fdfd>'+str(dDOB)+'<fdfd>'+str(dMDay)+'<fdfd>'+str(dMobile)+'<fdfd>'+str(dCAddress)+'<fdfd>'+str(dDist)+'<fdfd>'+str(dThana)+'<fdfd>'+str(OtherChamber)+'<fdfd>'+str(dPharmaRoute)+'<fdfd>'+str(dNMDRoute)
           ...
           return 'FAILED<SYNCDATA>Invalid Authorization'
            ...
            if userType=='rep':
                ...
                if docRowsGet:
                    ...
                    des                     =docRowsGet[0][db.sm_doctor_temp.des]
...
#             return db._lastsql
            ...
            if docRow:  
                ...
                dCAddress               =docRow[0][db.sm_doctor_temp.des]
...
#         holidayCheck=1
    ...
    if cRow_check:
        ...
        cStr='Please Update App '#Download Link:  http://w05.yeapps.com/d/kpl/'
...
#         reportShow=reportShow+'</tr>'
    ...
    for x in range(len(recordDoc)): 
        recordD=recordDoc[x]  
        reportShow=reportShow+'<tr>'
        reportShow=reportShow+'<td style="background-color:#FFC">'+str(recordD["doc_id"])+'</td>'+'<td style="background-color:#FFC">'+str(recordD["doc_name"])+'</td>'+'<td></td>'+'<td></td>'+'<td></td>'+'<td></td>'+'<td></td>'+'<td></td>'+'<td></td>'+'<td></td>'+'<td></td>'+'<td></td>'+'<td></td>'+'<td></td>'+'<td></td>'+'<td></td>'+'<td></td>'+'<td></td>'+'<td></td>'+'<td></td>'+'<td></td>'+'<td></td>'+'<td></td>'+'<td></td>'+'<td></td>'+'<td></td>'+'<td></td>'+'<td></td>'+'<td></td>'+'<td></td>'+'<td></td>'+'<td></td>'+'<td></td>'+'<td style="background-color:#FFC">0</td>'
        reportShow=reportShow+'</tr>'
    ...
    reportShowfinal=reportShowHead+'<font style="font-size:14px; color:#004080">Number of Doctors in this territory: </font><font style="font-size:14px; color:#B70060">'+str(docTr)+'</font><br><font style="font-size:14px; color:#004080">Number of Doctors visited in this territory: </font><font style="font-size:14px; color:#B70060">'+str(docCunt)+'</font><br><font style="font-size:14px; color:#004080">Total number of Doctor Visit: </font><font style="font-size:14px; color:#B70060">'+str(totalVisit)+'</font>'+reportShow
...
#     =========================================
    ...
    totalVisit=0
    reportShow=reportShow+'<table width="100%" border="1" cellpadding="0" cellspacing="0">'
    reportShow=reportShow+'<tr>'+'<td style="background-color:#FFC">Client</td>'+'<td style="background-color:#FFC">ClientName</td>'+'<td>01</td>'+'<td>02</td>'+'<td>03</td>'+'<td>04</td>'+'<td>05</td>'+'<td>06</td>'+'<td>07</td>'+'<td>08</td>'+'<td>09</td>'+'<td>10</td>'+'<td>11</td>'+'<td>12</td>'+'<td>13</td>'+'<td>14</td>'+'<td>15</td>'+'<td>16</td>'+'<td>17</td>'+'<td>18</td>'+'<td>19</td>'+'<td>20</td>'+'<td>21</td>'+'<td>22</td>'+'<td>23</td>'+'<td>24</td>'+'<td>25</td>'+'<td>26</td>'+'<td>27</td>'+'<td>28</td>'+'<td>29</td>'+'<td>30</td>'+'<td>31</td>'+'<td style="background-color:#FFC">Total</td>'+'</tr>'
    for recRep in recRep:
        docCunt=docCunt+1
        total=0
#         total=int(recRep.d_1)+int(recRep.d_2)+int(recRep.d_3)+int(recRep.d_4)+int(recRep.d_5)+int(recRep.d_6)+int(recRep.d_7)+int(recRep.d_8)+int(recRep.d_9)+int(recRep.d_10)+int(recRep.d_11)+int(recRep.d_12)+int(recRep.d_13)+int(recRep.d_14)+int(recRep.d_15)+int(recRep.d_16)+int(recRep.d_17)+int(recRep.d_18)+int(recRep.d_19)+int(recRep.d_20)+int(recRep.d_21)+int(recRep.d_22)+int(recRep.d_23)+int(recRep.d_24)+int(recRep.d_25)+int(recRep.d_26)+int(recRep.d_27)+int(recRep.d_28)+int(recRep.d_29)+int(recRep.d_30)+int(recRep.d_31)
        ...
        reportShow=reportShow+'<tr>'
        reportShow=reportShow+'<td style="background-color:#FFC">'+str(recRep.client_id)+'</td>'+'<td style="background-color:#FFC">'+str(recRep.client_name)+'</td>'+'<td>'+str(d_1)+'</td>'+'<td>'+str(d_2)+'</td>'+'<td>'+str(d_3)+'</td>'+'<td>'+str(d_4)+'</td>'+'<td>'+str(d_5)+'</td>'+'<td>'+str(d_6)+'</td>'+'<td>'+str(d_7)+'</td>'+'<td>'+str(d_8)+'</td>'+'<td>'+str(d_9)+'</td>'+'<td>'+str(d_10)+'</td>'+'<td>'+str(d_11)+'</td>'+'<td>'+str(d_12)+'</td>'+'<td>'+str(d_13)+'</td>'+'<td>'+str(d_14)+'</td>'+'<td>'+str(d_15)+'</td>'+'<td>'+str(d_16)+'</td>'+'<td>'+str(d_17)+'</td>'+'<td>'+str(d_18)+'</td>'+'<td>'+str(d_19)+'</td>'+'<td>'+str(d_20)+'</td>'+'<td>'+str(d_21)+'</td>'+'<td>'+str(d_22)+'</td>'+'<td>'+str(d_23)+'</td>'+'<td>'+str(d_24)+'</td>'+'<td>'+str(d_25)+'</td>'+'<td>'+str(d_26)+'</td>'+'<td>'+str(d_27)+'</td>'+'<td>'+str(d_28)+'</td>'+'<td>'+str(d_29)+'</td>'+'<td>'+str(d_30)+'</td>'+'<td>'+str(d_31)+'</td>'+'<td style="background-color:#FFC">'+str(total)+'</td>'
        reportShow=reportShow+'</tr>'
    ...
    for x in range(len(recordDoc)): 
        recordD=recordDoc[x] 
        reportShow=reportShow+'<tr>'
        reportShow=reportShow+'<td style="background-color:#FFC">'+str(recordD["client_id"])+'</td>'+'<td style="background-color:#FFC">'+str(recordD["name"])+'</td>'+'<td></td>'+'<td></td>'+'<td></td>'+'<td></td>'+'<td></td>'+'<td></td>'+'<td></td>'+'<td></td>'+'<td></td>'+'<td></td>'+'<td></td>'+'<td></td>'+'<td></td>'+'<td></td>'+'<td></td>'+'<td></td>'+'<td></td>'+'<td></td>'+'<td></td>'+'<td></td>'+'<td></td>'+'<td></td>'+'<td></td>'+'<td></td>'+'<td></td>'+'<td></td>'+'<td></td>'+'<td></td>'+'<td></td>'+'<td></td>'+'<td></td>'+'<td style="background-color:#FFC">0</td>'
        reportShow=reportShow+'</tr>'
...
#     ========================
    ...
    reportShow=reportShow+'</table>'
    reportShowfinal=reportShowHead+'<font style="font-size:14px; color:#004080">Number of Clients in this territory: </font><font style="font-size:14px; color:#B70060">'+str(docTr)+'</font><br><font style="font-size:14px; color:#004080">Number Clients visited in this territory: </font><font style="font-size:14px; color:#B70060">'+str(docCunt)+'</font><br><font style="font-size:14px; color:#004080">Total amount of Client Visit: </font><font style="font-size:14px; color:#B70060">'+str(totalVisit)+'</font>'+reportShow
...
#                     New===========
                ...
                chemistRows = db((db.sm_client_temp.cid == cid) & (db.sm_client_temp.status != 'REJECTED') & (db.sm_client_temp.area_id == route) & (db.sm_client_temp.newChemist == 1) ).select(db.sm_client_temp.id,db.sm_client_temp.client_id,db.sm_client_temp.name, db.sm_client_temp.address, db.sm_client_temp.contact_no1,db.sm_client_temp.trade_license_no,db.sm_client_temp.vat_registration_no,db.sm_client_temp.photo, orderby=db.sm_client_temp.client_id)
#                 return doctorRows
                if not chemistRows:
                    pass
...
#         ================SL ready============
        checkSl = db((db.sm_farm.cid == cid)).select(db.sm_farm.farm_id, orderby=~db.sm_farm.farm_id, limitby=(0, 1))
        if checkSl:
            farm_id = int(checkSl[0][db.sm_farm.farm_id]) + 1
        else:
            farm_id = 1
...
#         ================SL ready============
        ...
        if checkSl:
            ...
            farm_id = 1
#             client_insert=db.sm_farm.insert(cid=cid,farm_id=farm_id,farm_name=farm_name,owner_name=owner_name,address=str(address),dob=dob,anniversary=anniversary,medicine=medicine,manger_name=manger_name,consultant_name=consultant_name,category=category,birds_animal=birds_animal,rearing_housing=rearing_housing,feeding=feeding,watering=watering,brooding=brooding,poandsSize=poandsSize,status='ACTIVE')#,image=imageName,latitude=latitude,longitude=longitude)            
...
def fv_submit():
    ...
    if not compRow:
        ...
        if not repRow:
            ...
            # insert_track_check_in = db.sm_tracking_table.insert(cid=cid, rep_id=rep_id, rep_name=rep_name,call_type='FARM', visit_date=current_date,visit_time=datetime_fixed,visited_latlong=track_latlong)
...
#============================= Test dynamic path
def dmpath():
    #return '<start>http://127.0.0.1:8000/novivo/syncmobile_417_web_firm_01/<fd>http://i001.yeapps.com/image_hub/static/mundi_image/<fd>http://i001.yeapps.com/image_hub/mundi_image/<fd>http://127.0.0.1:8000/novivo/syncmobile_417_web_firm_01/<fd>http://127.0.0.1:8000/novivo/syncmobile_417_web_firm_01/<fd>http://127.0.0.1:8000/novivo/tour_web/<fd>http://127.0.0.1:8000/novivo/tour_web_members/<end>'
    #
    # return '<start>http://127.0.0.1:8000/novivo/syncmobile_417_web_firm/<fd>http://i001.yeapps.com/image_hub/static/mundi_image/<fd>http://i001.yeapps.com/image_hub/mundi_image/<fd>http://127.0.0.1:8000/novivo/syncmobile_417_web_firm/<fd>http://127.0.0.1:8000/novivo/syncmobile_417_web_firm/<fd>http://127.0.0.1:8000/novivo/tour_web/<fd>http://w011.yeapps.com/novivo/tour_web_members/<end>'
    return '<start>http://w05.yeapps.com/novivo/syncmobile_417_web_firm_01/<fd>http://i001.yeapps.com/image_hub/static/mundi_image/<fd>http://i001.yeapps.com/image_hub/mundi_image/<fd>http://w05.yeapps.com/novivo/syncmobile_417_web_firm_01/<fd>http://w05.yeapps.com/novivo/syncmobile_417_web_firm_01/<fd>http://a007.yeapps.com/novivo/tour_web/<fd>http://w05.yeapps.com/novivo/tour_web_members/<end>'

    return '<start>http://w011.yeapps.com/novivo/syncmobile_417_web_firm/<fd>http://i001.yeapps.com/image_hub/static/mundi_image/<fd>http://i001.yeapps.com/image_hub/mundi_image/<fd>http://w011.yeapps.com/novivo/syncmobile_417_web_firm/<fd>http://w011.yeapps.com/novivo/syncmobile_417_web_firm/<fd>http://a007.yeapps.com/novivo/tour_web/<fd>http://w011.yeapps.com/novivo/tour_web_members/<end>'
