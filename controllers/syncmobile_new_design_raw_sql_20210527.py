...
#  visit Count  
    if (user_type=='REP'):
        ...
        linkPath="window.open('"+sals_rprt_more_path+"salesDcr_report_detail?"+"cid="+cid+"&rep_id="+rep_id+"&password="+password+"&synccode="+synccode+"&se_item_report="+se_item_report+"&se_market_report="+se_market_report+" ', '_system');"
