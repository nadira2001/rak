...
def doctor_visit_arrange():
    ...
    # qset=qset(db.sm_doctor_visit.rep_id=='ITMSO')
    # qset=qset(db.sm_doctor_visit.id=='273793')
    ...
    for record in records:
        ...
        if record.giftnsample!='' : 
            ...
            if len(dataList)==4:
                ...
                # return str(sampleList)+'---------'+str(giftList)+'---------'+str(ppmList)
# #                 return sampleList
#                 
# #                 Proposed==============
