...
def diary_image():
    ...
    if check_Rows:
        ...
        diaryImgRows = db((db.sm_diary_image.cid == cid) &(db.sm_diary_image.rep_id == rep_id) ).select(db.sm_diary_image.ALL, orderby=db.sm_diary_image.diary_img_date,limitby=(0,10))
