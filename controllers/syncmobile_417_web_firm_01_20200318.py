           ...
           return 'FAILED<SYNCDATA>Invalid Authorization'+'<br><br><br>'
            ...
            if records:  
                ...
                for record in records:  
                    ...
                    invoice_str=invoice_str+'<table width="500" border="0" cellspacing="0" cellpadding="0" style="color:#306161">'
                    invoice_str=invoice_str+'<tr ><td width="100" style="padding-left:0px;"><b>Branch</b></td><td width="5"><b>:</b></td><td width="300" align="left">'+str(depot_name) + '('+str(depot_id) +')'+'</td><td width="100" style="padding-left:0px;"><b>OrderSL</b></td><td width="5"><b>:</b></td><td width="300" align="left">'+str(sl) +'</td></tr>'
                    invoice_str=invoice_str+'<tr ><td width="100" style="padding-left:0px;"><b>Store</b></td><td width="5"><b>:</b></td><td width="300" align="left">'+str(store_name) + '('+str(store_id) +')'+'</td><td width="100" style="padding-left:0px;"><b>OrderDate</b></td><td width="5"><b>:</b></td><td width="300" align="left">'+str(order_datetime)+'</td></tr>'
                    invoice_str=invoice_str+'</table>'
...
#     return '<start>http://w011.yeapps.com/novivo/syncmobile_417_web_firm/<fd>http://i001.yeapps.com/image_hub/static/mundi_image/<fd>http://i001.yeapps.com/image_hub/mundi_image/<fd>http://w011.yeapps.com/novivo/syncmobile_417_web_firm/<fd>http://w011.yeapps.com/novivo/syncmobile_417_web_firm/<fd>http://a007.yeapps.com/novivo/tour_web/<fd>http://w011.yeapps.com/novivo/tour_web_members/<end>'
    # return '<start>http://127.0.0.1:8000/novivo/syncmobile_417_web_firm/<fd>http://i001.yeapps.com/image_hub/static/mundi_image/<fd>http://i001.yeapps.com/image_hub/mundi_image/<fd>http://127.0.0.1:8000/novivo/syncmobile_417_web_firm/<fd>http://127.0.0.1:8000/novivo/syncmobile_417_web_firm/<fd>http://127.0.0.1:8000/novivo/tour_web/<fd>http://127.0.0.1:8000/novivo/tour_web_members/<end>'
    #
