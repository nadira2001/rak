...
#     Special rate==================
    ...
    for itemSpecialRows in itemSpecialRows:
        ...
        tp = itemSpecialRows.tp
        vat = itemSpecialRows.vat
        min_qty = itemSpecialRows.min_qty
#         return min_qty
        total= float(tp)+float(vat)
#         return total
...
#     Flat rate==================
    ...
    for itemFlatRows in itemFlatRows:
        ...
        vat = itemFlatRows.vat
        min_qty = itemFlatRows.min_qty      
        itemFlatList.append(str(product_id))
        flat_rateT=float(flat_rate)+float(vat)
        itemFlatList_str.append('Flat:Min '+str(min_qty)+' Rate '+str(flat_rateT))
