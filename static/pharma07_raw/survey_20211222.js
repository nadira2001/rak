...
function check_user() {	
	...
	// var  apipath_base_photo_dm='http://127.0.0.1:8000/navana/syncmobile_new_design_raw_sql/dmpath?CID='+cid +'&HTTPPASS=e99business321cba'
	// apu====
	// var  apipath_base_photo_dm='http://w05.yeapps.com/navana/syncmobile_new_design_raw_sql_test/dmpath?CID='+cid +'&HTTPPASS=e99business321cba'
	// apu end====
	var  apipath_base_photo_dm='http://w05.yeapps.com/dmpath/dmpath_new_design_raw/get_path?CID='+cid +'&HTTPPASS=e99business321cba'
	// var  apipath_base_photo_dm='http://w05.yeapps.com/dmpath/dmpath_new_design/get_path?CID='+cid +'&HTTPPASS=e99business321cba'
...
function tour_amnd(){
	...
	var linkPath="window.open('http://w05.yeapps.com/navana/tour_web_members/teamShow_web?"+"cid="+localStorage.cid+"&rep_id="+localStorage.user_id+"&rep_pass="+localStorage.user_pass	+"&monthPass=Next', '_system');"
	 var linkPath1="window.open('http://w05.yeapps.com/navana/track_mobile/tracking_index?"+"cid="+localStorage.cid+"&rep_id="+localStorage.user_id+"&rep_pass="+localStorage.user_pass	+"&monthPass=Next', '_system');"
...
function marketRetailerNext_doc() {
	//Nadira=2021
		...
		var year_1 = currentDate_1.getFullYear()
		var hour_1 = currentDate_1.getHours()
		var min_1 = currentDate_1.getMinutes()
		var sec_1 = currentDate_1.getSeconds()
		var today_1=  year_1 + "-" + month_1 + "-" + day_1+" "+hour_1+":"+min_1+":"+sec_1
		localStorage.doc_start_time=today_1
		// alert (today_1)
		...
		//		}else{
										...
										if (visitClientId=='' || visitClientId==undefined){
											...
											// alert (localStorage.base_url+'doctor_visit_submit_pharma?cid='+localStorage.cid+'&rep_id='+localStorage.user_id+'&rep_pass='+localStorage.user_pass+'&synccode='+localStorage.synccode+'&client_id='+visitClientId+'&visit_type='+visit_type+'&schedule_date='+scheduled_date+'&msg='+encodeURI(msg)+'&lat='+lat+'&long='+longitude+'&v_with='+v_with+'&route='+market_Id+'&doc_others='+doc_others+'&location_detail='+localStorage.location_detail+'&imageName='+imageName+'&v_shift='+v_shift)
											 $("#errorChkVSubmit_doc_t").val(localStorage.base_url+'doctor_visit_submit_pharma?cid='+localStorage.cid+'&rep_id='+localStorage.user_id+'&rep_pass='+localStorage.user_pass+'&synccode='+localStorage.synccode+'&client_id='+visitClientId+'&visit_type='+visit_type+'&schedule_date='+scheduled_date+'&msg='+encodeURI(msg)+'&lat='+lat+'&long='+longitude+'&v_with='+v_with+'&route='+market_Id+'&doc_others='+doc_others+'&location_detail='+localStorage.location_detail+'&imageName='+imageName+'&v_shift='+v_shift+'&s_time='+localStorage.doc_start_time)
												// ajax-------
												//alert (localStorage.location_error);
											if ( localStorage.location_error==2){
